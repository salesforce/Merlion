...
from merlion.utils.time_series import TimeSeries, get_timedelta_seconds
...
class TestETS(unittest.TestCase):
    ...
    def test_forecast(self):
        ...
        while t < tf:
            ...
            cur_test = cur_test.window(
                t, t + get_timedelta_seconds(start=t, periods=1, granularity=self.model.timedelta)
            )
