...
with ``pandas.DataFrame`` and ``pandas.Series``, respectively. Check the linked API docs for a full list of features,
or the `example code <https://github.com/salesforce/Merlion/tree/master/examples>`_
for some examples on how to use them.
