...
from merlion.utils.time_series import get_timedelta_seconds, TimeSeries, UnivariateTimeSeries
...
class ETS(ForecasterBase):
    ...
    def forecast(
        ...
        if time_series_prev is not None:
            ...
            dt = get_timedelta_seconds(start=self.last_train_time, granularity=self.timedelta, periods=1)
